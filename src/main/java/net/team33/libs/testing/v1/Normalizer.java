...
/**
 * <p>A tool that can convert virtually any object into a normalized form so that they can be compared using
 * {@link Object#equals(Object) equals()} / {@link Object#hashCode() hashCode()} and have a meaningful
 * {@link Object#toString() string representation}. </p>
 * <p>This can be useful if objects are to be checked for an expected value*, but for which there is no suitable
 * implementation of the methods mentioned above.</p>
 * <p>*(e.g. using {@code assertEquals()})</p>
